...
namespace AspNetCoreAngularVehicleManager.Migrations
{
    ...
    [Migration("20170627205147_AddPhoto")]
    partial class AddPhoto
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("asp.net_core_angular_vehicle_manager.Core.Models.Photo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("asp.net_core_angular_vehicle_manager.Core.Models.Photo", b =>
                {
                    b.HasOne("asp.net_core_angular_vehicle_manager.Core.Models.Vehicle")
                        .WithMany("Photos")
